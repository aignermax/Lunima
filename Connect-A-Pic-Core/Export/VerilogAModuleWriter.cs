...
internal static class VerilogAModuleWriter
{
    ...
    internal static string Write(Component comp, string moduleName, int wavelengthNm)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("// ======================================================================");
        sb.AppendLine("// KNOWN LIMITATION — tracked in Lunima issue #484:");
        sb.AppendLine("//   The `V(port) <+ expr` contribution form below is over-constrained");
        sb.AppendLine("//   when the parent netlist drives a port with a voltage source.");
        sb.AppendLine("//   NGSpice will report \"DC solution failed\" for any non-trivial");
        sb.AppendLine("//   test bench. Phase information is also lost (only the real part of");
        sb.AppendLine("//   the S-matrix is used). The module parses and compiles with OpenVAF");
        sb.AppendLine("//   — it does NOT yet produce physically correct simulation results.");
        sb.AppendLine("// ======================================================================");
        sb.AppendLine();
