...
namespace CAP_Core.Components.Core
{
    ...
    {
        private static readonly CoordinateTranslationService CoordService = new();
        ...
        /// Delegates to <see cref="CoordinateTranslationService.GetPinNazcaPosition"/>.
        /// </summary>
        public (double x, double y) GetAbsoluteNazcaPosition()
        {
            return CoordService.GetPinNazcaPosition(this);
        }
