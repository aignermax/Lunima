...
public class InstanceNazcaCodeEditorPinOverrideTests
{
    ...
    public void BuildOverridePins_ConvertsNazcaCoordsToComponentLocal()
    {
        ...
        var pins = InstanceNazcaCodeEditorViewModel.BuildOverridePins(result);
    ...
    public void PinNamesMatch_SameNames_ReturnsTrue()
    {
        ...
        InstanceNazcaCodeEditorViewModel.PinNamesMatch(a, b).ShouldBeTrue();
    }
    ...
    public void PinNamesMatch_DifferentNames_ReturnsFalse()
    {
        ...
        InstanceNazcaCodeEditorViewModel.PinNamesMatch(a, b).ShouldBeFalse();
    }
    ...
    public void PinNamesMatch_BothEmpty_ReturnsTrue()
        => InstanceNazcaCodeEditorViewModel.PinNamesMatch(
